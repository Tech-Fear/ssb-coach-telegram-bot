  ...
  const settings = [
    {
      ...
      secondAction: "organized a short briefing and divided responsibilities clearly",
      result: "the event continued smoothly"
    },
    {
      place: "village",
      issue: "children lacked a clean place to study",
      firstAction: "discussed the issue with local residents and identified an unused room",
    ...
    },
    {
      ...
      secondAction: "included the junior in practice and guided him step by step",
    ...
    },
    {
      ...
      secondAction: "planned a cleanliness drive and arranged follow-up maintenance",
    ...
    },
    {
      ...
      firstAction: "collected correct information and reassured the waiting passengers",
      secondAction: "organized alternatives and guided people according to priority",
  ...
  const situations = [
    {
      ...
      context: "people were uncertain about what to do next and were waiting for someone to take initiative",
      firstAction: "quickly understood the situation and spoke calmly to the group",
      secondAction: "assigned simple responsibilities, clarified the immediate objective, and ensured everyone stayed coordinated",
      outcome: "within a short time the confusion reduced, work became organized, and the group regained confidence"
    },
    {
      cue: "helping after a minor breakdown",
      context: "movement had stopped and nearby people were worried about delay and inconvenience",
      firstAction: "checked the problem carefully and made sure the surroundings were safe",
      secondAction: "arranged the basic tools available, involved nearby people helpfully, and focused on a practical temporary solution",
      outcome: "the issue was managed without panic and normal activity resumed smoothly"
    },
    {
      cue: "addressing a community need",
      context: "the local people had been facing a repeated difficulty but had not yet organized a practical response",
      firstAction: "listened to the concern, identified the most urgent need, and proposed an achievable plan",
      secondAction: "gathered support from others, divided tasks clearly, and personally supervised the first steps of the solution",
      outcome: "the community responded positively, progress started quickly, and people became more confident about solving the issue together"
    },
    {
      cue: "assisting a traveler in difficulty",
      context: "the person looked confused and needed timely guidance to avoid missing an important connection",
      firstAction: "approached confidently, verified the problem, and reassured the person",
      secondAction: "checked the correct information, helped with movement where needed, and directed the traveler to the proper place",
      outcome: "the traveler avoided delay and the situation was resolved in an orderly way"
    },
    {
      cue: "organizing a small awareness activity",
      context: "a few people were present but there was no structure, so the activity risked becoming ineffective",
      firstAction: "briefed the group on the purpose and created immediate clarity",
      secondAction: "delegated speaking, logistics, and coordination tasks, then monitored progress and encouraged participation",
      outcome: "the activity was completed effectively and the group felt motivated by the result"
    }
  ];
  const items = [];
  let id = 1;
