...
function formatDailyPackMessages(pack) {
  ...
  return [
    ...
    { type: "photo", photoCandidates: buildImageCandidates("tat", pack.tat.prompt, pack.tat.key), caption: tatCaption },
    { type: "text", text: srtMessage },
    { type: "photo", photoCandidates: buildImageCandidates("ppdt", pack.ppdt.prompt, pack.ppdt.key), caption: ppdtCaption }
  ];
}
